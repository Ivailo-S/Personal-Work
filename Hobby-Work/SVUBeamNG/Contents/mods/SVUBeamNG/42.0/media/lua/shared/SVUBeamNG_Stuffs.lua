...
SetArmor("LiftBX240DX","PU_Armor_BXLift");
SetArmor("CoupeBX240DX","PU_Armor_BXCoupe");
SetArmor("LiftBX240LX","PU_Armor_BXLift");
SetArmor("CoupeBX240LX","PU_Armor_BXCoupe");
SetArmor("BX240LXz","PU_Armor_BXLift");
SetArmor("BX240GTz","PU_Armor_BXLift");
SetArmor("PoliceBX","PU_Armor_BXLift");
SetArmor("DianaBXLS","PU_Armor_BXCoupe");
SetArmor("DianaBXGTz","PU_Armor_BXCoupe");
