...
VehicleZoneDistribution.medium.vehicles["Base.DuneHopper"] = {index = -1, spawnChance = 0.5}; 
VehicleZoneDistribution.medium.vehicles["Base.SportHopper"] = {index = -1, spawnChance = 0.5};

VehicleZoneDistribution.good.vehicles["Base.XT4Hopper"] = {index = -1, spawnChance = 2};
VehicleZoneDistribution.good.vehicles["Base.XT6Hopper"] = {index = -1, spawnChance = 3};
VehicleZoneDistribution.good.vehicles["Base.LXT4Hopper"] = {index = -1, spawnChance = 2};
VehicleZoneDistribution.good.vehicles["Base.LXT6Hopper"] = {index = -1, spawnChance = 3};
...
VehicleZoneDistribution.junkyard.vehicles["Base.XT4Hopper"] = {index = -1, spawnChance = 1};
VehicleZoneDistribution.junkyard.vehicles["Base.XT6Hopper"] = {index = -1, spawnChance = 1};
VehicleZoneDistribution.junkyard.vehicles["Base.LXT4Hopper"] = {index = -1, spawnChance = 1};
VehicleZoneDistribution.junkyard.vehicles["Base.LXT6Hopper"] = {index = -1, spawnChance = 1};

VehicleZoneDistribution.trafficjamw.vehicles["Base.XT4Hopper"] = {index = -1, spawnChance = 1};
VehicleZoneDistribution.trafficjamw.vehicles["Base.XT6Hopper"] = {index = -1, spawnChance = 1};
VehicleZoneDistribution.trafficjamw.vehicles["Base.LXT4Hopper"] = {index = -1, spawnChance = 1};
VehicleZoneDistribution.trafficjamw.vehicles["Base.LXT6Hopper"] = {index = -1, spawnChance = 1};
VehicleZoneDistribution.trafficjamw.vehicles["Base.ZXT6Hopper"] = {index = -1, spawnChance = 0.5};
VehicleZoneDistribution.trafficjamw.vehicles["Base.DuneHopper"] = {index = -1, spawnChance = 0.5}; 
VehicleZoneDistribution.trafficjamw.vehicles["Base.SportHopper"] = {index = -1, spawnChance = 0.5};
VehicleZoneDistribution.trafficjamw.vehicles["Base.SheriffHopper"] = {index = -1, spawnChance = 1};

VehicleZoneDistribution.police.vehicles["Base.SheriffHopper"] = {index = -1, spawnChance = 50};
VehicleZoneDistribution.police.specialCar = true;

VehicleZoneDistribution.ranger.vehicles["Base.RangerHopper"] = {index = -1, spawnChance = 75};
